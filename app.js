var myModule = angular.module('Raigeek', []);

myModule.factory('RaigeekHelper', function() {
...
myModule.service('RaigeekModel', function() {
    var service = this,
        statuses = [
            {name: 'Back Log'},
            {name: 'To Do'},
...
myModule.controller('MainCtrl', function(RaigeekModel, RaigeekHelper) {
    var main = this;

    main.types = RaigeekModel.getTypes();
    main.statuses = RaigeekModel.getStatuses();
    main.stories = RaigeekModel.getStories();
    main.typesIndex = RaigeekHelper.buildIndex(main.types, 'name');
    main.statusesIndex = RaigeekHelper.buildIndex(main.statuses, 'name');
